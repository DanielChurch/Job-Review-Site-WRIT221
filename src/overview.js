                ...
                <div class="card article">
                  <div class="card-content">
                    ...
                    <div class="content article-body">
                      <p>
                        Welcome to our job review site! Here, you can easily search for jobs and their salaries. You can also see
                        real employee reviews and photos of the company, so you can make sure you want to work there!
                      </p>
                      <p>
                        First, feel free to stay on this page and look at the various guides! Over time, more and more
                        will be added, so be sure to check back later for more! To start using the site, visit the salaries
                        tab. This will be the main area for your job search.
                      </p>
                      <h3 class="has-text-centered">
                        Make sure to login to our website!
                      </h3>
                      <p>
                        Take full advantage of what this website has to offer by logging in! In order to view an unlimited
                        ...
                        review, salary information, and photos!
                      </p>
                      <br />
                    </div>
                  </div>
              ...
              <section class="articles">
                <div class="card article">
                  <div class="card-content">
                    ...
                    <div class="content article-body">
                      <p>
                        During your job search, it is important that you do not waste time! The job market is very competitive,
                        and you need to do your best to make a decision on where you want to work as fast as possible. This guide will
                        help you make that choice.
                      </p>
                      <p>
                        Firstly, if you are already employed and want a new job, what you can easily do here is compare jobs.
                        See the difference between average salaires, positions and reviews.
                      </p>
                      <h3 class="has-text-centered">
                        Make the right decision the first time.
                      </h3>
                      <p>
                        Make sure you look at all aspects of a job before considering to apply. Reviews or salary information
                        ...
                        a job has to offer. If you are not happy where you work, you are bound to underperform.
                      </p>
                    </div>
                  </div>
                </div>
